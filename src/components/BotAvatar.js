export default function BotAvatar({ size = 48, className = '' }) {
  return (
    ...
    >
      {/* 안테나 */}
      <rect x="46" y="4" width="8" height="15" rx="4" fill="#7c3aed" />
      <circle cx="50" cy="3" r="6" fill="#f59e0b" />
      <circle cx="50" cy="3" r="3" fill="#fbbf24" />

      {/* 머리 */}
      <rect x="16" y="16" width="68" height="52" rx="20" fill="#7c3aed" />

      {/* 하이라이트 */}
      <ellipse cx="50" cy="22" rx="24" ry="6" fill="white" opacity="0.12" />

      {/* 얼굴 스크린 */}
      <rect x="25" y="24" width="50" height="38" rx="13" fill="#ede9fe" />

      {/* 왼쪽 눈 */}
      <circle cx="38" cy="40" r="7.5" fill="#7c3aed" />
      <circle cx="40.5" cy="37.5" r="2.5" fill="white" />

      {/* 오른쪽 눈 */}
      <circle cx="62" cy="40" r="7.5" fill="#7c3aed" />
      ...
      {/* 귀 */}
      <rect x="8" y="29" width="10" height="20" rx="5" fill="#6d28d9" />
      <rect x="82" y="29" width="10" height="20" rx="5" fill="#6d28d9" />
